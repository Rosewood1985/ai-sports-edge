...
const RedeemGiftScreen: React.FC = () => {
  ...
  const handleRedeemGift = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Error',
        error.message || 'Failed to redeem gift subscription. Please try again.'
      );
    } finally {
      setLoading(false);
    }
      ...
      <ThemedView style={styles.container}>
        <View style={styles.successContainer}>
          ...
          <Text style={styles.successMessage}>
            Your gift subscription has been activated successfully. You now have access to all
            premium features.
          </Text>
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <TouchableOpacity style={styles.redeemButton} onPress={handleRedeemGift} disabled={loading}>
        {loading ? (
      ...
      <ThemedText style={styles.helpText}>
        If you received a gift subscription from a friend, they should have provided you with a gift
        code. Enter it above to activate your premium access.
      </ThemedText>
    </ThemedView>
  );
};
