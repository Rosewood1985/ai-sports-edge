    ...
    <SafeAreaView style={[styles.container, { backgroundColor }]}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.metricSelectionContainer}>
          ...
          >
            {(['points', 'assists', 'rebounds', 'steals', 'blocks', 'fieldGoalPercentage'] as const).map((metric) => (
              <TouchableOpacity
                key={metric}
                style={[
                  styles.metricButton,
                  selectedMetric === metric ? { backgroundColor: primaryColor } : { borderColor: primaryColor, borderWidth: 1 }
                ]}
        ...
        <View style={styles.chartSection}>
          ...
          {hasChartData && chartData ? (
                ...
                <View style={styles.statItem}>
                  ...
                  <ThemedText style={styles.statValue}>
                    {selectedMetric === 'fieldGoalPercentage'
                      ...
                      : (playerData.recentGamesAverages[selectedMetric].reduce((a, b) => a + b, 0) / playerData.recentGamesAverages[selectedMetric].length).toFixed(1)
                    }
                  </ThemedText>
                </View>
            ...
            <View style={styles.noDataContainer}>
              <Ionicons name="analytics-outline" size={48} color={textColor} style={{ opacity: 0.5 }} />
        ...
        <View style={styles.trendAnalysisSection}>
          ...
          {hasChartData ? (
            ...
            <View style={styles.noDataContainer}>
              <ThemedText style={styles.noDataText}>Insufficient data for trend analysis</ThemedText>
            </View>
          )}
        </View>
      </ScrollView>
