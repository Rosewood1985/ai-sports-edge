 ...
 * Version 3 - Removed NFL games, added more variety of sports
 */
...
async function fetchUpcomingGames() {
  try {
    ...
    console.log('Fetched games:', allGames); // Debug log
    
    return allGames.length > 0 ? allGames : getFallbackGames();
  } catch (error) {
...
async function initSportsTicker() {
  console.log('Initializing sports ticker - V3 (Slower animation, mixed sports)'); // Debug log
