...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" href="ai_logo.webp">
  <link rel="apple-touch-icon" href="ai_logo.webp">
  ...
  <header class="header">
    <div class="container">
      <div class="header-content">
        <a href="/" class="logo">
          <img src="ai_logo.webp" alt="AI Sports Edge Logo" style="width: 40px; height: 40px;">
      ...
      <div class="hero-content">
        ...
        <div class="hero-right">
          <div class="hero-image">
            <img src="ai_logo.webp" alt="AI Sports Edge" style="width: 150px; height: 150px;">
          </div>
          <div class="news-feed">
...
.login-page::before {
  ...
  right: 0;
  bottom: 0;
  background: url('ai_logo.webp') no-repeat center center;
...
try {
  // Clear the public directory first (except for README.md, ai_logo.webp, and sports API files)
  const publicFiles = fs.readdirSync(publicDir);
  for (const file of publicFiles) {
    if (file !== 'README.md' && file !== 'ai_logo.webp' && !file.startsWith('sports-api')) {
