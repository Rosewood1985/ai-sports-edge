...
const wcagCriteria = [
  ...
  { id: '1.2.1', name: 'Audio-only and Video-only', level: 'A', description: 'Alternatives for time-based media' },
  { id: '1.2.2', name: 'Captions', level: 'A', description: 'Captions are provided for all prerecorded audio' },
  { id: '1.2.3', name: 'Audio Description or Media Alternative', level: 'A', description: 'Alternative for time-based media or audio description' },
  { id: '1.3.1', name: 'Info and Relationships', level: 'A', description: 'Information, structure, and relationships can be programmatically determined' },
  { id: '1.3.2', name: 'Meaningful Sequence', level: 'A', description: 'Correct reading sequence can be programmatically determined' },
  { id: '1.3.3', name: 'Sensory Characteristics', level: 'A', description: 'Instructions don\'t rely solely on sensory characteristics' },
  { id: '1.3.4', name: 'Orientation', level: 'AA', description: 'Content not restricted to specific orientation' },
  { id: '1.3.5', name: 'Identify Input Purpose', level: 'AA', description: 'Input purpose can be programmatically determined' },
  { id: '1.4.1', name: 'Use of Color', level: 'A', description: 'Color is not the only visual means of conveying information' },
  { id: '1.4.2', name: 'Audio Control', level: 'A', description: 'Mechanism to pause, stop, or control audio volume' },
  { id: '1.4.3', name: 'Contrast (Minimum)', level: 'AA', description: 'Text has contrast ratio of at least 4.5:1' },
  { id: '1.4.4', name: 'Resize Text', level: 'AA', description: 'Text can be resized up to 200% without loss of content or function' },
  { id: '1.4.5', name: 'Images of Text', level: 'AA', description: 'Text is used rather than images of text' },
  { id: '1.4.10', name: 'Reflow', level: 'AA', description: 'Content can be presented without loss of information or functionality' },
  { id: '1.4.11', name: 'Non-text Contrast', level: 'AA', description: 'Visual presentation of UI components and graphical objects have contrast ratio of at least 3:1' },
  { id: '1.4.12', name: 'Text Spacing', level: 'AA', description: 'No loss of content or functionality when text spacing is adjusted' },
  { id: '1.4.13', name: 'Content on Hover or Focus', level: 'AA', description: 'Additional content that appears on hover or focus can be dismissed' },
  { id: '2.1.1', name: 'Keyboard', level: 'A', description: 'All functionality is available from a keyboard' },
  { id: '2.1.2', name: 'No Keyboard Trap', level: 'A', description: 'Keyboard focus is not trapped' },
  { id: '2.1.4', name: 'Character Key Shortcuts', level: 'A', description: 'Shortcuts using only letter, punctuation, number, or symbol characters can be turned off or remapped' },
  { id: '2.2.1', name: 'Timing Adjustable', level: 'A', description: 'Time limits can be turned off, adjusted, or extended' },
  { id: '2.2.2', name: 'Pause, Stop, Hide', level: 'A', description: 'Moving, blinking, scrolling, or auto-updating content can be paused, stopped, or hidden' },
  { id: '2.3.1', name: 'Three Flashes or Below Threshold', level: 'A', description: 'No content flashes more than three times in one second' },
  { id: '2.4.1', name: 'Bypass Blocks', level: 'A', description: 'Mechanism to bypass blocks of content that are repeated on multiple pages' },
  ...
  { id: '2.4.4', name: 'Link Purpose (In Context)', level: 'A', description: 'Purpose of each link can be determined from the link text or context' },
  { id: '2.4.5', name: 'Multiple Ways', level: 'AA', description: 'More than one way to locate a page' },
  ...
  { id: '2.5.1', name: 'Pointer Gestures', level: 'A', description: 'All functionality that uses multipoint or path-based gestures can be operated with a single pointer' },
  { id: '2.5.2', name: 'Pointer Cancellation', level: 'A', description: 'Functions that can be operated using a single pointer do not require down-event to complete' },
  { id: '2.5.3', name: 'Label in Name', level: 'A', description: 'For user interface components with labels, the name contains the text that is presented visually' },
  { id: '2.5.4', name: 'Motion Actuation', level: 'A', description: 'Functionality that can be operated by device motion or user motion can also be operated by user interface components' },
  { id: '3.1.1', name: 'Language of Page', level: 'A', description: 'Human language of page can be programmatically determined' },
  { id: '3.1.2', name: 'Language of Parts', level: 'AA', description: 'Human language of parts can be programmatically determined' },
  { id: '3.2.1', name: 'On Focus', level: 'A', description: 'When any component receives focus, it does not initiate a change of context' },
  { id: '3.2.2', name: 'On Input', level: 'A', description: 'Changing the setting of any user interface component does not automatically cause a change of context' },
  { id: '3.2.3', name: 'Consistent Navigation', level: 'AA', description: 'Navigational mechanisms that are repeated on multiple pages occur in the same relative order' },
  { id: '3.2.4', name: 'Consistent Identification', level: 'AA', description: 'Components that have the same functionality are identified consistently' },
  { id: '3.3.1', name: 'Error Identification', level: 'A', description: 'Input errors are identified and described to the user' },
  { id: '3.3.2', name: 'Labels or Instructions', level: 'A', description: 'Labels or instructions are provided when content requires user input' },
  { id: '3.3.3', name: 'Error Suggestion', level: 'AA', description: 'Suggestions for error correction are provided' },
  { id: '3.3.4', name: 'Error Prevention', level: 'AA', description: 'For pages that cause legal commitments or financial transactions, submissions are reversible, checked, or confirmed' },
  { id: '4.1.1', name: 'Parsing', level: 'A', description: 'No major code errors' },
  { id: '4.1.2', name: 'Name, Role, Value', level: 'A', description: 'For all user interface components, the name and role can be programmatically determined' },
  { id: '4.1.3', name: 'Status Messages', level: 'AA', description: 'Status messages can be programmatically determined' }
];

// Mobile-specific accessibility checks
const mobileChecks = [
  { id: 'M1', name: 'Touch Target Size', description: 'Touch targets are at least 44x44 points' },
  { id: 'M2', name: 'Gesture Alternatives', description: 'Complex gestures have simpler alternatives' },
  { id: 'M3', name: 'Screen Reader Compatibility', description: 'All elements are accessible to screen readers' },
  { id: 'M4', name: 'Screen Orientation', description: 'Content works in both portrait and landscape orientations' },
  { id: 'M5', name: 'Keyboard Accessibility', description: 'App is fully usable with external keyboard' },
  ...
  { id: 'M8', name: 'Text Resizing', description: 'App handles system text size changes gracefully' },
...
function scanFile(filePath) {
  ...
  if (fileExtension === '.tsx' || fileExtension === '.jsx') {
    ...
    if (fileContent.includes('fontSize:') && !fileContent.includes('getFontScale') && !fileContent.includes('accessibilityService')) {
      issues.push({
        file: filePath,
        ...
        suggestion: 'Use accessibilityService.getFontScale() to adjust font sizes based on user preferences'
      });
    }
  }
...
function generateReport(issues) {
  ...
  const criteriaWithIssues = Object.keys(criterionIssues).filter(key => criterionIssues[key].issues.length > 0).length;
  ...
  const summary = {
    ...
    warningCount,
    criteriaWithIssues,
    passRate: wcagCriteria.length > 0 ? 
      Math.round(((wcagCriteria.length - criteriaWithIssues) / wcagCriteria.length) * 100) : 0,
