...
async function runTests() {
  console.log(
    `${colors.bright}${colors.yellow}Starting Enhanced Player Statistics Tests${colors.reset}`
  );
  ...
  try {
    ...
    console.log(
      `Weather Service: ${weatherTestSuccess ? colors.green + 'PASSED' : colors.red + 'FAILED'}${colors.reset}`
    );
    console.log(
      `View Counter Service: ${viewCounterTestSuccess ? colors.green + 'PASSED' : colors.red + 'FAILED'}${colors.reset}`
    );
