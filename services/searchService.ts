...
class SearchService {
  ...
  async searchNews(query: string, filters?: SearchFilters): Promise<NewsSearchResult[]> {
    try {
      // Create base query
      let newsQuery = firebaseService.firestore.firebaseService.firestore.collection(firestore, 'news');
  ...
  async searchTeams(query: string, filters?: SearchFilters): Promise<TeamSearchResult[]> {
    try {
      // Create base query
      let teamsQuery = firebaseService.firestore.firebaseService.firestore.collection(firestore, 'teams');
  ...
  async searchPlayers(query: string, filters?: SearchFilters): Promise<PlayerSearchResult[]> {
    try {
      // Create base query
      let playersQuery = firebaseService.firestore.firebaseService.firestore.collection(firestore, 'players');
  ...
  async searchOdds(query: string, filters?: SearchFilters): Promise<OddsSearchResult[]> {
    try {
      // Create base query
      let oddsQuery = firebaseService.firestore.firebaseService.firestore.collection(firestore, 'odds');
  ...
  async getSearchHistory(userId: string, maxItems: number = 10): Promise<SearchHistoryItem[]> {
    try {
      const historyQuery = firebaseService.firestore.firebaseService.firestore.query(
        firebaseService.firestore.firebaseService.firestore.collection(firestore, 'searchHistory'),
        firebaseService.firestore.firebaseService.firestore.where('userId', '==', userId),
        firebaseService.firestore.firebaseService.firestore.orderBy('timestamp', 'desc'),
        firebaseService.firestore.firebaseService.firestore.limit(maxItems)
      );
  ...
  async saveSearchQuery(
    ...
    try {
      ...
      // Add to Firestore
      await addDoc(firebaseService.firestore.firebaseService.firestore.collection(firestore, 'searchHistory'), historyItem);
      ...
      if (preferences.maxHistoryItems > 0) {
        ...
        if (allHistory.length > preferences.maxHistoryItems) {
          ...
          for (const item of itemsToDelete) {
            await deleteDoc(firebaseService.firestore.firebaseService.firestore.doc(firestore, 'searchHistory', item.id));
          }
        }
      }
    } catch (error) {
  ...
  async getSearchPreferences(userId: string): Promise<SearchPreferences> {
    try {
      const preferencesQuery = firebaseService.firestore.firebaseService.firestore.query(
        firebaseService.firestore.firebaseService.firestore.collection(firestore, 'searchPreferences'),
        firebaseService.firestore.firebaseService.firestore.where('userId', '==', userId),
  ...
  async updateSearchPreferences(userId: string, preferences: SearchPreferences): Promise<void> {
    try {
      ...
      if (snapshot.empty) {
        ...
        await addDoc(firebaseService.firestore.firebaseService.firestore.collection(firestore, 'searchPreferences'), {
          userId,
          ...preferences
        });
      } else {
