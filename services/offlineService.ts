...
class OfflineService {
  ...
  private async getDataFromFirestore<T>(
    ...
    try {
      const docRef = firebaseService.firestore.firebaseService.firestore.doc(firestore, collectionPath, docId);
  ...
  private async queryDataFromFirestore<T>(
    ...
    try {
      ...
      const collectionRef = firebaseService.firestore.firebaseService.firestore.collection(firestore, collectionPath);
      
      // Build query
      let queryRef = firebaseService.firestore.firebaseService.firestore.query(collectionRef);
      
      // Add where clause if field, operator, and value are provided
      if (field && operator && value !== undefined) {
        queryRef = firebaseService.firestore.firebaseService.firestore.query(queryRef, firebaseService.firestore.firebaseService.firestore.where(field, operator, value));
      }
      
      // Add orderBy clause if orderByField is provided
      if (orderByField) {
        queryRef = firebaseService.firestore.firebaseService.firestore.query(queryRef, firebaseService.firestore.firebaseService.firestore.orderBy(orderByField, orderByDirection || 'asc'));
      }
      
      // Add limit clause if limitTo is provided
      if (limitTo) {
        queryRef = firebaseService.firestore.firebaseService.firestore.query(queryRef, firebaseService.firestore.firebaseService.firestore.limit(limitTo));
      }
