...
class BettingSlipImportService {
  ...
  public async checkSubscriptionRequirements(userId: string): Promise<SubscriptionRequirements> {
    try {
      // Get user document
      const userDoc = await getDoc(firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.doc(firestore, this.USER_COLLECTION, userId));
      ...
      const subscriptionsQuery = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.query(
        firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.collection(firestore, this.SUBSCRIPTION_COLLECTION),
        ...
        firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.where('status', '==', 'active')
      );
  ...
  public async importFromScreenshot(
    ...
    try {
      ...
      for (const bet of mockBets) {
        await addDoc(firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.collection(firestore, this.IMPORTED_BETS_COLLECTION), bet);
      }
      
      // Save import history
      await addDoc(firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.collection(firestore, this.IMPORT_HISTORY_COLLECTION), {
        id: importId,
        userId,
