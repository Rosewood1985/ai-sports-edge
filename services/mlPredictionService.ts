...
class MLPredictionService {
  ...
  private async getModelMetadata(sport: string): Promise<ModelMetadata | null> {
    try {
      const modelRef = firebaseService.firestore.firebaseService.firestore.doc(firestore, this.MODEL_REGISTRY_COLLECTION, sport);
  ...
  private async getHistoricalAccuracy(sport: string): Promise<number> {
    try {
      ...
      const feedbackRef = firebaseService.firestore.firebaseService.firestore.collection(firestore, this.FEEDBACK_COLLECTION);
      const q = firebaseService.firestore.firebaseService.firestore.query(
        feedbackRef,
        firebaseService.firestore.firebaseService.firestore.where('sportType', '==', sport),
        firebaseService.firestore.firebaseService.firestore.orderBy('timestamp', 'desc'),
        firebaseService.firestore.firebaseService.firestore.limit(100)
      );
  ...
  private async storePrediction(
    ...
    try {
      ...
      const predictionRef = firebaseService.firestore.firebaseService.firestore.doc(firestore, 'predictions', gameId);
  ...
  public async recordFeedback(gameId: string, actualWinner: string): Promise<boolean> {
    try {
      ...
      // Store feedback
      const feedbackRef = firebaseService.firestore.firebaseService.firestore.doc(firestore, this.FEEDBACK_COLLECTION, gameId);
  ...
  private async checkForRetraining(sport: string): Promise<void> {
    try {
      ...
      const q = firebaseService.firestore.firebaseService.firestore.query(
        ...
        firebaseService.firestore.firebaseService.firestore.where('sportType', '==', sport),
        firebaseService.firestore.firebaseService.firestore.orderBy('timestamp', 'desc'),
        firebaseService.firestore.firebaseService.firestore.limit(this.MIN_FEEDBACK_FOR_TRAINING + 1)
      );
