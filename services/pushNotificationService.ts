...
class PushNotificationService {
  ...
  public async getNotificationPreferences(): Promise<NotificationPreferences> {
    try {
      ...
      const docRef = firebaseService.firestore.firebaseService.firestore.doc(firestore, 'users', userId, 'settings', 'notifications');
  ...
  public async scheduleNotification(
    ...
    try {
      ...
      const notificationsRef = firebaseService.firestore.firebaseService.firestore.collection(firestore, 'scheduledNotifications');
  ...
  public async cancelScheduledNotification(notificationId: string): Promise<void> {
    try {
      ...
      const docRef = firebaseService.firestore.firebaseService.firestore.doc(firestore, 'scheduledNotifications', notificationId);
  ...
  public async getScheduledNotifications(): Promise<ScheduledNotification[]> {
    try {
      ...
      const q = firebaseService.firestore.firebaseService.firestore.query(
        ...
        firebaseService.firestore.firebaseService.firestore.where('sent', '==', false),
        firebaseService.firestore.firebaseService.firestore.where('scheduledAt', '>', new Date())
      );
