...
export const getUserSportsPreferences = async (): Promise<UserSportsPreferences> => {
  try {
    ...
    const db = firestore;
    const userDocRef = firebaseService.firestore.firebaseService.firestore.doc(db, 'users', userId);
    const prefsDocRef = firebaseService.firestore.firebaseService.firestore.doc(firebaseService.firestore.firebaseService.firestore.collection(userDocRef, 'preferences'), 'sports');
...
export const getUserBettingHistorySummary = async (): Promise<{
  ...
  try {
    ...
    const db = firestore;
    const userDocRef = firebaseService.firestore.firebaseService.firestore.doc(db, 'users', userId);
    const betsCollectionRef = firebaseService.firestore.firebaseService.firestore.collection(userDocRef, 'bets');
