...
class ClaudeOptimizationService {
  ...
  private async getCachedResponse(cacheKey: string, type: ClaudeRequestType): Promise<ClaudeResponse | null> {
    try {
      ...
      const cacheRef = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.doc(firestore, this.CLAUDE_CACHE_COLLECTION, cacheKey);
  ...
  private async checkRateLimit(userId: string, type: ClaudeRequestType): Promise<boolean> {
    try {
      ...
      const rateLimitRef = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.doc(firestore, this.CLAUDE_RATE_LIMIT_COLLECTION, `${userId}_${type}_${currentHour}`);
  ...
  private async trackCacheHit(type: ClaudeRequestType): Promise<void> {
    try {
      ...
      const statsRef = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.doc(firestore, this.CLAUDE_USAGE_COLLECTION, 'cache_stats');
  ...
  private async trackUsage(request: ClaudeRequest, response: ClaudeResponse): Promise<void> {
    try {
      ...
      const userStatsRef = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.doc(firestore, this.CLAUDE_USAGE_COLLECTION, userId);
  ...
  public async getMonthlyUsageReport(month: string = new Date().toISOString().slice(0, 7)): Promise<any> {
    try {
      // Get global stats
      const globalStatsRef = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.doc(firestore, this.CLAUDE_USAGE_COLLECTION, 'global');
      ...
      // Get cache stats
      const cacheStatsRef = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.doc(firestore, this.CLAUDE_USAGE_COLLECTION, 'cache_stats');
