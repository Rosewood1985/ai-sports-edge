...
const firestore = firebaseService.firestore.instance;
const functions = firebaseService.functions.instance;
...
export const getGroupSubscription = async (groupId: string): Promise<any> => {
  try {
    ...
    const groupSubscriptionRef = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.doc(firestore, 'groupSubscriptions', groupId);
...
export const getOwnedGroupSubscriptions = async (userId: string): Promise<any[]> => {
  try {
    ...
    const groupSubscriptionsRef = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.collection(firestore, 'groupSubscriptions');
    const q = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.query(groupSubscriptionsRef, firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.where('ownerId', '==', userId));
...
export const getMemberGroupSubscriptions = async (userEmail: string): Promise<any[]> => {
  try {
    ...
    const groupSubscriptionsRef = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.collection(firestore, 'groupSubscriptions');
    const q = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.query(groupSubscriptionsRef, firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.where('members', 'array-contains', userEmail));
    const querySnapshot = await getDocs(q);
...
export const isPartOfActiveGroupSubscription = async (userEmail: string): Promise<boolean> => {
  try {
    ...
    const groupSubscriptionsRef = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.collection(firestore, 'groupSubscriptions');
    const q = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.query(
      groupSubscriptionsRef, 
      firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.where('members', 'array-contains', userEmail),
      firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.where('status', '==', 'active')
    );
    const querySnapshot = await getDocs(q);
