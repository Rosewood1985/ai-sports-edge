...
class GameUrlService {
  ...
  private async loadApiKeys(): Promise<void> {
    try {
      ...
      const apiKeysDocRef = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.doc(firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.collection(firestore, COLLECTIONS.API_KEYS), 'sports');
  ...
  private async saveToFirestore(gameUrls: GameUrl[]): Promise<void> {
    try {
      ...
      gameUrls.forEach(gameUrl => {
        const gameUrlsCollection = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.collection(firestoreInstance, COLLECTIONS.GAME_URLS);
        const docRef = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.doc(gameUrlsCollection, gameUrl.gameId);
        batch.set(docRef, {
          ...gameUrl,
  ...
  async getGameUrl(gameId: string, bettingSite: BettingSite = BettingSite.FANDUEL): Promise<string | null> {
    ...
    try {
      ...
      const firestoreInstance = firestore;
      const gameUrlsCollection = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.collection(firestoreInstance, COLLECTIONS.GAME_URLS);
      const gameDocRef = firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.firebaseService.firestore.doc(gameUrlsCollection, gameId);
