...
export const fetchPlayerPlusMinus = async (gameId: string): Promise<void> => {
  try {
    ...
    for (const player of players) {
      ...
      const playerCollection = firebaseService.firestore.firebaseService.firestore.collection(firestore, 'playerPlusMinus');
      const docRef = firebaseService.firestore.firebaseService.firestore.doc(playerCollection, `${gameId}_${player.id}`);
...
export const getPlayerPlusMinus = async (gameId: string, playerId: string): Promise<PlayerPlusMinus | null> => {
  try {
    ...
    const playerCollection = firebaseService.firestore.firebaseService.firestore.collection(firestore, 'playerPlusMinus');
    const docRef = firebaseService.firestore.firebaseService.firestore.doc(playerCollection, `${gameId}_${playerId}`);
    const docSnap = await getDocs(firebaseService.firestore.firebaseService.firestore.query(playerCollection, firebaseService.firestore.firebaseService.firestore.where('gameId', '==', gameId), firebaseService.firestore.firebaseService.firestore.where('playerId', '==', playerId)));
...
export const getGamePlusMinus = async (gameId: string): Promise<PlayerPlusMinus[]> => {
  try {
    ...
    const playerCollection = firebaseService.firestore.firebaseService.firestore.collection(firestore, 'playerPlusMinus');
    const q = firebaseService.firestore.firebaseService.firestore.query(playerCollection, firebaseService.firestore.firebaseService.firestore.where('gameId', '==', gameId));
