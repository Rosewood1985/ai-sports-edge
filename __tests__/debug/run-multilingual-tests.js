...
try {
  ...
  const output = execSync('npx jest --config=jest.config.js __tests__/debug/multilingual-error-test.js --verbose', { 
    encoding: 'utf8',
    stdio: 'pipe'
  });
  ...
  console.log();
  console.log(`${colors.bright}${colors.cyan}Summary of Multilingual Error Handling Improvements:${colors.reset}`);
  console.log();
  ...
  console.log(`   - Tests verify that error messages are properly displayed in different languages`);
