...
describe('Multilingual Error Handling', () => {
  ...
  test('displays API errors in English', async () => {
    ...
    const ApiErrorComponent = () => {
      ...
      return <button data-testid="api-button" onClick={handleApiError}>Make API Request</button>;
    };
  ...
  test('displays API errors in Spanish', async () => {
    ...
    i18n.translations = {
      es: {
        ...
        api: {
          network_error: 'Error de red. Por favor, verifique su conexión a Internet e inténtelo de nuevo.'
        }
      }
    };
    ...
    const LanguageSwitchComponent = () => {
      ...
      return (
        <div>
          ...
          <button data-testid="spanish-button" onClick={switchToSpanish}>Switch to Spanish</button>
          <button data-testid="english-button" onClick={switchToEnglish}>Switch to English</button>
        </div>
      );
    };
