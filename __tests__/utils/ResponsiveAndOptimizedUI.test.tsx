...
const TestFadeComponent = ({ onAnimationComplete }: { onAnimationComplete?: () => void }) => {
  ...
  return (
    <View>
      ...
      <Text testID="start-button" onPress={() => startFade(onAnimationComplete)}>Start Animation</Text>
    </View>
  );
};
...
const TestScaleComponent = ({ onAnimationComplete }: { onAnimationComplete?: () => void }) => {
  ...
  return (
    <View>
      ...
      <Text testID="start-button" onPress={() => startScale(onAnimationComplete)}>Start Animation</Text>
    </View>
  );
};
...
const TestSlideComponent = ({ onAnimationComplete }: { onAnimationComplete?: () => void }) => {
  ...
  return (
    <View>
      ...
      <Text testID="start-button" onPress={() => startSlide(onAnimationComplete)}>Start Animation</Text>
    </View>
  );
};
...
const TestSequenceComponent = ({ onAnimationComplete }: { onAnimationComplete?: () => void }) => {
  ...
  const { startSequence } = useOptimizedSequence([
    startFade,
    startScale
  ]);
  ...
  return (
    <View>
      ...
      <Text testID="start-button" onPress={() => {
        startSequence();
...
describe('Animation Optimization', () => {
  ...
  describe('useOptimizedFade', () => {
    it('should create and start a fade animation', () => {
      ...
      const { getByTestId } = render(<TestFadeComponent onAnimationComplete={onAnimationComplete} />);
  ...
  describe('useOptimizedScale', () => {
    it('should create and start a scale animation', () => {
      const onAnimationComplete = jest.fn();
      const { getByTestId } = render(<TestScaleComponent onAnimationComplete={onAnimationComplete} />);
  ...
  describe('useOptimizedSlide', () => {
    it('should create and start a slide animation', () => {
      const onAnimationComplete = jest.fn();
      const { getByTestId } = render(<TestSlideComponent onAnimationComplete={onAnimationComplete} />);
  ...
  describe('useOptimizedSequence', () => {
    it('should create and start a sequence of animations', () => {
      const onAnimationComplete = jest.fn();
      const { getByTestId } = render(<TestSequenceComponent onAnimationComplete={onAnimationComplete} />);
  ...
  describe('useAutoStartAnimation', () => {
    ...
    it('should restart animation when dependencies change', () => {
      ...
      rerender(<TestAutoStartComponent shouldStart={true} />);
