    ...
    try {
      ...
      if (savedSteps) {
        try {
          ...
          const validSteps = parsedSteps.every(
            step =>
              step &&
              typeof step === 'object' &&
...
const getDefaultSteps = language => {
  return [
    ...
    },
    {
      ...
      title:
        language === 'es'
          ? 'Nunca Más Te Pierdas las Mejores Cuotas'
          : 'Never Miss the Best Odds Again',
      description:
        language === 'es'
    ...
    },
    {
      ...
      title:
        language === 'es' ? 'Tu Analista de Apuestas Personal' : 'Your Personal Betting Analyst',
      description:
        language === 'es'
