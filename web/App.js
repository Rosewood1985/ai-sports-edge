  ...
  useEffect(() => {
    if (onboardingComplete === false && !loading) {
      ...
      const isOnboardingPath =
        currentPath.endsWith('/onboarding') || currentPath.endsWith('/feature-tour');
  ...
  const NotificationPermission = () => {
    ...
    return (
      <div className="notification-banner">
        ...
        <button className="close-button" onClick={() => setShowBanner(false)}>
          ×
        </button>
      </div>
    );
