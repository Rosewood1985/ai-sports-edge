      ...
      <div className="preferences-content">
        ...
        <section className="preferences-section">
          ...
          <p className="section-description">
            Select which sports categories you want to see in the news ticker.
          </p>
        ...
        <section className="preferences-section">
          ...
          <p className="section-description">
            Add keywords to filter news items. Include filters will only show items containing these
            keywords. Exclude filters will hide items containing these keywords.
          </p>
