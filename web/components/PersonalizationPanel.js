        ...
        <div className="personalization-section">
          ...
          <div className="preference-item">
            <div className="preference-info">
              ...
              <span className="preference-description">Select sports to prioritize in your feed</span>
            </div>
          </div>
        ...
        <div className="personalization-section">
          ...
          <div className="preference-item">
            <div className="preference-info">
              ...
              <span className="preference-description">Display confidence level for AI predictions</span>
            </div>
            <label className="toggle-switch">
              <input 
                type="checkbox" 
          ...
          <div className="preference-item">
            <div className="preference-info">
              ...
              <span className="preference-description">Display your betting history on the profile page</span>
            </div>
            <label className="toggle-switch">
              <input 
                type="checkbox" 
        ...
        <div className="personalization-section">
          ...
          <div className="preference-item">
            <div className="preference-info">
              ...
              <span className="preference-description">Set your preferred level of risk for betting recommendations</span>
            </div>
            <select 
          ...
          <div className="preference-item">
            <div className="preference-info">
              ...
              <span className="preference-description">Choose how odds are displayed throughout the app</span>
            </div>
            <select 
        ...
        <div className="personalization-section">
          ...
          <div className="preference-item">
            <div className="preference-info">
              ...
              <span className="preference-description">Allow us to use your betting history to improve predictions</span>
            </div>
            <label className="toggle-switch">
              <input 
                type="checkbox" 
          ...
          <div className="preference-item">
            <div className="preference-info">
              ...
              <span className="preference-description">Help us improve by sharing anonymous usage data</span>
            </div>
            <label className="toggle-switch">
              <input 
                type="checkbox" 
