  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore AI Sports Edge subscription plans. Choose the plan that fits your betting strategy and budget."
        />
        <meta
          name="keywords"
          content="AI Sports Edge pricing, subscription plans, sports betting app pricing"
        />
          ...
          <div className="pricing-hero-content">
            ...
            <p>
              {showGroupPlanOnly
                ...
                : 'Choose the plan that fits your betting strategy and budget.'}
            </p>
          </div>
        </div>
      </section>
                    ...
                    <div className="plan-cta">
                      ...
                      {showBetButton('pricing') && (
                        <div className="plan-bet-button">
                          <BetNowButton size="medium" position="inline" contentType="pricing" />
                        </div>
                      )}
                    </div>
                  </div>
            ...
            <section className="annual-discount" id="annual-discount-section">
              <div className="container">
                <div className="discount-content">
                  ...
                  <p>
                    Get {annualPlan.name} for ${annualPlan.price}/year and save compared to monthly
                    billing.
                  </p>
                  <div className="discount-buttons">
                    ...
                    {showBetButton('pricing') && (
                      <BetNowButton size="large" position="inline" contentType="pricing" />
                    )}
                  </div>
                </div>
              </div>
            ...
            <div className="group-content">
              ...
              <div className="group-plan-card">
                ...
                <div className="group-plan-description">
                  ...
                  <p className="time-requirement">
                    <strong>Important:</strong> All members must register within 24 hours for the
                    group subscription to activate.
                  </p>
                </div>
                <div className="group-plan-features">
                  <ul>
                    ...
                    <li className="highlight-feature">
                      24-hour registration window for all members
                    </li>
                  </ul>
                </div>
                <div className="group-plan-cta">
                  <Link to="/download" className="button group-button">
        ...
        <div className="container">
          ...
          <div className="faq-grid">
            ...
            <div className="faq-item">
              ...
              <p>
                Yes, we offer a 7-day free trial for all new users. You can experience all the
                features of the Premium plan before deciding to subscribe.
              </p>
            </div>
            ...
            <div className="faq-item">
              ...
              <p>
                You can easily upgrade or downgrade your plan at any time through the app's settings
                menu. Changes will take effect at the start of your next billing cycle.
              </p>
            </div>
            ...
            <div className="faq-item">
              ...
              <p>
                ...
                subscription. Contact our support team to request a refund.
              </p>
            </div>
            ...
            <div className="faq-item">
              ...
              <p>
                Individual subscriptions are for personal use only. For sharing with friends or
                family, check out our Group Subscription option which allows up to 3 users.
              </p>
            </div>
            ...
            <div className="faq-item">
              ...
              <p>
                We accept all major credit cards, PayPal, and Apple Pay/Google Pay for mobile
                subscriptions.
              </p>
            </div>
          </div>
      ...
      <section className="pricing-cta">
        <div className="container">
          ...
          <p>
            Join thousands of users who are making smarter betting decisions with AI Sports Edge.
          </p>
