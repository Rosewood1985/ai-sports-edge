   ...
   <div className="about-page-container" style={{ position: 'relative', zIndex: 9999 }}>
     ...
     <SimpleHeader />
      <Helmet>
        ...
        <meta name="description" content="Learn about AI Sports Edge, our mission, and the team behind the revolutionary sports betting app." />
        <meta name="keywords" content="AI Sports Edge, about us, sports betting app, company mission" />
      ...
      <section className="about-story">
        <div className="container">
          <div className="story-content">
            <h2>Our Story</h2>
            <p>AI Sports Edge was founded in 2023 by a team of sports enthusiasts, data scientists, and software engineers who saw an opportunity to apply advanced machine learning techniques to the world of sports betting.</p>
            <p>What began as a passion project quickly evolved into a comprehensive platform that analyzes vast amounts of sports data to generate accurate predictions and valuable insights. Our team has grown, but our core mission remains the same: to help bettors make smarter decisions through technology and data.</p>
            <p>Today, AI Sports Edge serves thousands of users across the globe, providing them with AI-powered predictions, real-time analytics, and a supportive community of like-minded bettors.</p>
          </div>
        </div>
      </section>
          ...
          <div className="team-grid">
            <div className="team-member">
              <div className="team-member-image">
                <div className="placeholder-avatar" aria-label="Team member photo"></div>
              </div>
              <h3>Samuel Johnson</h3>
              <p className="team-member-title">Founder & CEO</p>
              <p className="team-member-bio">Former sports analyst with a background in machine learning and a passion for sports betting.</p>
            </div>
            ...
            <div className="team-member">
              ...
              <p className="team-member-bio">PhD in Statistics with expertise in predictive modeling and sports analytics.</p>
            </div>
            ...
            <div className="team-member">
              ...
              <p className="team-member-bio">Full-stack engineer with a focus on mobile app development and real-time data processing.</p>
            </div>
            ...
            <div className="team-member">
              ...
              <p className="team-member-bio">Product strategist with experience in sports media and betting platforms.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="values-grid">
            <div className="value-item">
              ...
              <h3>Accuracy</h3>
              <p>We're committed to providing the most accurate predictions and insights possible, constantly refining our algorithms and models.</p>
            </div>
            ...
            <div className="value-item">
              ...
              <h3>Integrity</h3>
              <p>We operate with transparency and honesty, ensuring our users can trust the information and tools we provide.</p>
            </div>
            ...
            <div className="value-item">
              ...
              <h3>Innovation</h3>
              <p>We continuously push the boundaries of what's possible with AI and sports analytics, staying at the forefront of technology.</p>
            </div>
            ...
            <div className="value-item">
              ...
              <h3>Community</h3>
              <p>We foster a supportive community where bettors can learn from each other and grow together.</p>
            </div>
          </div>
        </div>
      </section>
