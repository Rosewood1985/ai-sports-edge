  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Download AI Sports Edge for iOS and Android. Get started with AI-powered sports betting predictions and analytics." />
        <meta name="keywords" content="download, AI Sports Edge, sports betting app, iOS, Android" />
      ...
      <section className="download-hero">
        <div className="container">
          <div className="download-hero-content">
            ...
            <p className="download-subtitle">Get started with AI-powered sports betting predictions today.</p>
          </div>
        </div>
      </section>
          ...
          <div className="download-grid">
            <div className="download-option">
              ...
              <div className="download-buttons">
                <a href="#" className="button disabled">Coming Soon to App Store</a>
                <a href="exp://exp.host/@aisportsedge/ai-sports-edge" className="button secondary">Open in Expo Go</a>
              </div>
              <div className="beta-option">
                <h3>iOS Beta Testing</h3>
                <p>Join our TestFlight beta program to get early access.</p>
                <a href="#" className="button secondary">Join TestFlight Beta</a>
              </div>
            </div>
            ...
            <div className="download-option">
              ...
              <div className="download-buttons">
                <a href="#" className="button disabled">Coming Soon to Google Play</a>
                <a href="exp://exp.host/@aisportsedge/ai-sports-edge" className="button secondary">Open in Expo Go</a>
              </div>
              <div className="beta-option">
                <h3>Android Beta Testing</h3>
                <p>Download our beta APK directly to your device.</p>
                <a href="#" className="button secondary">Download Beta APK</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="expo-steps">
            <div className="expo-step">
              ...
              <p>Download <a href="https://expo.dev/client" target="_blank" rel="noopener noreferrer">Expo Go</a> from the App Store or Google Play</p>
            </div>
            <div className="expo-step">
          ...
          <div className="expo-button">
            <a href="exp://exp.host/@aisportsedge/ai-sports-edge" className="button primary-button">Open in Expo Go</a>
          </div>
        </div>
      </section>
...
npx expo start`}
          ...
          <div className="github-button">
            <a href="https://github.com/aisportsedge/ai-sports-edge" target="_blank" rel="noopener noreferrer" className="button secondary-button">
