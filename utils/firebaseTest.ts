...
export const testFirestore = async (): Promise<any> => {
  try {
    ...
    const testDocRef = firebaseService.firestore.firebaseService.firestore.doc(firebaseService.firestore.firebaseService.firestore.collection(firestore, 'test'), 'connection');
