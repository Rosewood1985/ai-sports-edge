...
export const getWeatherApiKey = () =>
  getApiKey(
    API_KEYS.WEATHER_API_KEY.key,
    API_KEYS.WEATHER_API_KEY.isRequired,
    API_KEYS.WEATHER_API_KEY.serviceName
  );
export const getStripeSecretKey = () =>
  getApiKey(
    API_KEYS.STRIPE_SECRET_KEY.key,
    API_KEYS.STRIPE_SECRET_KEY.isRequired,
    API_KEYS.STRIPE_SECRET_KEY.serviceName
  );
export const getFanDuelAffiliateId = () =>
  getApiKey(
    API_KEYS.FANDUEL_AFFILIATE_ID.key,
    API_KEYS.FANDUEL_AFFILIATE_ID.isRequired,
    API_KEYS.FANDUEL_AFFILIATE_ID.serviceName
  );
export const getFanDuelApiKey = () =>
  getApiKey(
    API_KEYS.FANDUEL_API_KEY.key,
    API_KEYS.FANDUEL_API_KEY.isRequired,
    API_KEYS.FANDUEL_API_KEY.serviceName
  );
export const getSportRadarApiKey = () =>
  getApiKey(
    API_KEYS.SPORTRADAR_API_KEY.key,
    API_KEYS.SPORTRADAR_API_KEY.isRequired,
    API_KEYS.SPORTRADAR_API_KEY.serviceName
  );
export const getNcaaBasketballApiKey = () =>
  getApiKey(
    API_KEYS.NCAA_BASKETBALL_API_KEY.key,
    API_KEYS.NCAA_BASKETBALL_API_KEY.isRequired,
    API_KEYS.NCAA_BASKETBALL_API_KEY.serviceName
  );
