...
export const Header = ({
  ...
  return (
    <ThemedView background="surface" style={styles.header} accessible accessibilityRole="header">
      ...
      >
        {isLoading ? (
          ...
          <>
            ...
            />
            <ThemedText style={styles.refreshButtonText}>{t('oddsComparison.refresh')}</ThemedText>
          </>
        )}
      </TouchableOpacity>
    </ThemedView>
