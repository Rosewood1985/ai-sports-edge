...
export const API_KEYS = {
  // Sports Data API key
  SPORTS_DATA_API_KEY: getApiKey('REACT_APP_SPORTS_DATA_API_KEY', 'sportsDataApiKey'),

  // Odds API key
  ODDS_API_KEY: getApiKey('REACT_APP_ODDS_API_KEY', 'oddsApiKey'),

  // IP Geolocation API key
  IP_GEOLOCATION_API_KEY: getApiKey('REACT_APP_IPGEOLOCATION_API_KEY', 'ipgeolocationApiKey'),

  // Google Maps API key
  GOOGLE_MAPS_API_KEY: getApiKey('REACT_APP_GOOGLE_MAPS_API_KEY', 'googleMapsApiKey'),

  // Mapbox API key
  MAPBOX_API_KEY: getApiKey('REACT_APP_MAPBOX_API_KEY', 'mapboxApiKey'),
};
