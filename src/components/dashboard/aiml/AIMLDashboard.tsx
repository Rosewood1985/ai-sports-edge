    ...
    <div className={`ai-ml-dashboard ${className}`}>
      ...
      <div className="mb-6">
        <div className="sm:flex sm:items-center sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">AI/ML Dashboard</h1>
            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="flex items-center space-x-2">
              ...
              {stats.criticalAnomalies > 0 && (
                <div className="flex items-center text-sm text-red-600 dark:text-red-400">
                  ...
                  {stats.criticalAnomalies} critical anomal
                  {stats.criticalAnomalies !== 1 ? 'ies' : 'y'}
                </div>
              )}
            </div>
          </div>
