...
const routes = lazyLoadRoutes({
  ...
  '/onboarding/responsible-gambling': () => import('../screens/Onboarding/ResponsibleGamblingScreen'),
...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="/onboarding/self-exclusion" element={routes['/onboarding/self-exclusion'].component()} />
      <Route path="/onboarding/responsible-gambling" element={routes['/onboarding/responsible-gambling'].component()} />
      ...
      <Route path="/profile/purchase-history" element={routes['/profile/purchase-history'].component()} />
