...
const EnhancedPlayerStatistics: React.FC<EnhancedPlayerStatisticsProps> = ({
  ...
  const [upgradePromptType, setUpgradePromptType] = useState<
    'advanced-metrics' | 'historical-trends' | 'all'
  >('all');
        ...
        <ThemedText
          style={[
            ...
            player.stats.plusMinus > 0
              ? styles.positivePlusMinus
              : player.stats.plusMinus < 0
                ? styles.negativePlusMinus
      ...
      return (
        <View style={styles.lockedContainer}>
          ...
          <ThemedText style={styles.lockedText}>
            Advanced metrics are available with Premium subscription
          </ThemedText>
          <TouchableOpacity
      ...
      <View style={styles.statsContainer}>
        <View style={styles.advancedStatRow}>
          <View style={styles.advancedStatItem}>
            <ThemedText style={styles.advancedStatValue}>
              {player.stats.trueShootingPercentage?.toFixed(1) || '58.5'}%
            </ThemedText>
            <ThemedText style={styles.advancedStatLabel}>True Shooting %</ThemedText>
          </View>
          <View style={styles.advancedStatItem}>
            <ThemedText style={styles.advancedStatValue}>
              {player.stats.effectiveFieldGoalPercentage?.toFixed(1) || '52.3'}%
            </ThemedText>
        ...
        <View style={styles.advancedStatRow}>
          <View style={styles.advancedStatItem}>
            <ThemedText style={styles.advancedStatValue}>
              {player.stats.usageRate?.toFixed(1) || '25.3'}%
            </ThemedText>
            <ThemedText style={styles.advancedStatLabel}>Usage Rate</ThemedText>
          </View>
          <View style={styles.advancedStatItem}>
            <ThemedText style={styles.advancedStatValue}>
              {player.stats.playerEfficiencyRating?.toFixed(1) || '18.2'}
            </ThemedText>
        ...
        <View style={styles.advancedStatRow}>
          <View style={styles.advancedStatItem}>
            <ThemedText style={styles.advancedStatValue}>
              {player.stats.offensiveRating?.toFixed(1) || '112.4'}
            </ThemedText>
            <ThemedText style={styles.advancedStatLabel}>Offensive Rating</ThemedText>
          </View>
          <View style={styles.advancedStatItem}>
            <ThemedText style={styles.advancedStatValue}>
              {player.stats.defensiveRating?.toFixed(1) || '108.3'}
            </ThemedText>
        ...
        <View style={styles.insightContainer}>
          ...
          <ThemedText style={styles.insightText}>
            {player.name} is performing above average in offensive efficiency metrics, with a True
            Shooting % that ranks in the top 25% of players at his position.
          </ThemedText>
        </View>

        {/* Weather Insights */}
        <WeatherInsights gameId={gameId} playerId={player.id} playerName={player.name} />
      </View>
    );
  };
    ...
    if (!hasAccess.historical) {
      return (
        <View style={styles.lockedContainer}>
          <Ionicons name="lock-closed" size={48} color="#0a7ea4" />
          <ThemedText style={styles.lockedText}>
            Historical trends are available with Premium subscription
          </ThemedText>
          <TouchableOpacity
            style={styles.unlockButton}
            onPress={() => {
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={styles.historicalTable}>
          <View style={styles.historicalTableHeader}>
            <ThemedText style={[styles.historicalTableCell, styles.historicalTableHeaderText]}>
              Game
            </ThemedText>
            <ThemedText style={[styles.historicalTableCell, styles.historicalTableHeaderText]}>
              PTS
  ...
  return (
    <View style={styles.container}>
      ...
      <ViewLimitIndicator onUpgradePress={handleUpgradePress} compact />
      ...
      <View style={styles.tabContainer}>
        ...
        >
          <ThemedText style={[styles.tabText, activeTab === 'basic' && styles.activeTabText]}>
            Basic
          </ThemedText>
        </TouchableOpacity>
        ...
        >
          <View style={styles.tabContent}>
            <ThemedText style={[styles.tabText, activeTab === 'advanced' && styles.activeTabText]}>
              Advanced
            </ThemedText>
            {!hasAccess.advanced && (
        ...
        >
          <View style={styles.tabContent}>
            <ThemedText
              style={[styles.tabText, activeTab === 'historical' && styles.activeTabText]}
            >
              Historical
            </ThemedText>
            {!hasAccess.historical && (
              <Ionicons name="lock-closed" size={12} color="#fff" style={styles.lockIcon} />
            )}
          </View>
        </TouchableOpacity>
      ...
      <ScrollView style={styles.contentContainer}>
        ...
        {activeTab === 'basic' && (
          <View style={styles.viewLimitContainer}>
            <ViewLimitIndicator onUpgradePress={handleUpgradePress} compact={false} />
          </View>
        )}
      </ScrollView>
