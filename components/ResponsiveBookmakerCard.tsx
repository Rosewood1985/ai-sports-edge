      ...
      >
        ...
        <Text
          style={[
            ...
            isSmallScreen && styles.bookmakerNameSmall
          ]}
          numberOfLines={1}
          ellipsizeMode="tail"
        >
        ...
        <Text
          style={[
            styles.oddsValue,
            isSmallScreen && styles.oddsValueSmall
          ]}
        >
          {displayText}
        </Text>
