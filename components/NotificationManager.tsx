...
const NotificationManager: React.FC<NotificationManagerProps> = ({
   ...
   */
  const handleNotificationPress = (id: string, deepLink?: string, data?: Record<string, any>) => {
...
export const NotificationManagerContext = createContext<NotificationManagerContextValue | null>(
  null
);
